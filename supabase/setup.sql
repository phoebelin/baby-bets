...
select * from (values
  ...
  (2,  'What is a baby''s first non-crying way of communicating?',
       '["Smiling","Pointing","Waving","Clapping"]'::jsonb, 0),
  ...
  (5,  'What were pregnant bellies compared to for size updates, classically?',
       '["Sports balls","Fruits and veggies","Planets","Loaves of bread"]'::jsonb, 1),
  (6,  'When do babies usually take their first steps?',
       '["6–8 months","9–18 months","18–24 months","2–3 years"]'::jsonb, 1),
  ...
  (9,  'Which of these can a baby do in the womb?',
       '["Hiccup","Dream","Cry tears","Grow teeth"]'::jsonb, 0),
  (10, 'On average, new parents lose how much sleep in baby''s first year?',
       '["44 hours","250 hours","640 hours","1,000 hours"]'::jsonb, 2)
